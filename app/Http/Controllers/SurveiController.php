...
class SurveiController extends Controller
{
    ...
    public function update(Request $request, Survei $survei)
    {
        ...
        if ($request->hasFile('gambar_lahan')) {
            ...
            $permohonan = $survei->permohonan;
$idPendaftaran = $permohonan->id_pendaftaran;
$uploaded = $request->file('gambar_lahan');
$ext = $uploaded->getClientOriginalExtension();
$fileName = 'gambar_' . $idPendaftaran . '.' . $ext;
$path = $uploaded->storeAs('gambar_lahan', $fileName, 'public');
